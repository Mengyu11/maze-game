...
from maze_generating_function import *
import shutil
import pandas as pd
...
class App(tk.Tk):
    ...
    def __init__(self):
        ...
        # Loading menu music
        pygame.mixer.music.load(f"{os.getcwd()}/sounds/menu_ost.wav")
...
class GameMenu(tk.Canvas):
    ...
    def __init__(self,
        ...
        bg = ImageTk.PhotoImage(Image.open(f"{os.getcwd()}/graphics/menu_bg.png").resize((controller.width,
                                                                                          controller.height),
                                                                                         Image.ANTIALIAS))
    ...
    def add_button(self,
        ...
        button1 = CustomButton(master=self,
                               image_path=f"{os.getcwd()}/graphics/buttons/{button_name}.png",
                               command=lambda: [(quit() if function == "quit" else
                                                 self.controller.show_frame(function)),
                                                pygame.mixer.Channel(0).play(
                                                    pygame.mixer.Sound(f"{os.getcwd()}/sounds/button.wav"))])
...
class GameScreen(tk.Canvas):
    ...
    def __init__(self,
        ...
        # Adding music
        pygame.mixer.music.load(f"{os.getcwd()}/sounds/game_ost.mp3")
    ...
    def update_timer(self):
        ...
        if not self.is_paused:
            ...
            if elapsed_time > TIME_LIMIT:
                ...
                pygame.mixer.Channel(0).play(pygame.mixer.Sound(f"{os.getcwd()}/sounds/victory.wav"))
                return
    ...
    def check_if_next_level(self):
        ...
        pygame.mixer.Channel(0).play(pygame.mixer.Sound(f"{os.getcwd()}/sounds/door_unlock.wav"))
    ...
    def draw_level(self):
        ...
        if self.level_name:
            level.load_from_file(f"{os.getcwd()}/levels/{self.level_name}.txt")
        else:
            ...
            level.load_from_file(f"{os.getcwd()}/levels/tmp.txt")
    ...
    def end_of_game(self):
        ...
        end_game_image = ImageTk.PhotoImage(
            Image.open(f"{os.getcwd()}/graphics/end_game_info.png").resize((600, 480), Image.ANTIALIAS))
        self.create_image(340, 135, anchor="nw", image=end_game_image)
        self.images["end"] = end_game_image

        # Calculating final score
        score = self.P.coins_collected * 5 - TIME_LIMIT / 10 + DESTRUCTIBLE_BLOCKS

        # Creating go back to menu button
        go_back_to_menu = CustomButton(master=self,
                                       image_path=f"{os.getcwd()}/graphics/buttons/go_back_to_menu_button.png",
        ...
        for i, number in enumerate(numbers):
            num_photo = tk.PhotoImage(file=f"{os.getcwd()}/graphics/numbers/{number}.png")
        ...
        leaderboard = pd.read_csv("leaderboard.csv", header=None)
        ...
        leaderboard.iloc[:9, :].to_csv("leaderboard.csv", header=False, index=False)
...
class ModeChooser(tk.Canvas):
    ...
    def __init__(self,
        ...
        adv_mode = CustomButton(master=self,
                                image_path=f"{os.getcwd()}/graphics/buttons/adventure_mode_button.png",
        ...
        solo_mode = CustomButton(master=self,
                                 image_path=f"{os.getcwd()}/graphics/buttons/solo_mode_button.png",
    ...
    def choose_levels(self,
        ...
        pl_name_image = tk.PhotoImage(file=f"{os.getcwd()}/graphics/texts/player_name.png")
        # to prevent the image from being deleted by garbage collector we save it in dict.
        ...
        start_game = CustomButton(master=tmp_canvas,
                                  image_path=f"{os.getcwd()}/graphics/buttons/start_game_button.png",
        ...
        close_button = CustomButton(master=tmp_canvas,
                                    image_path=f"{os.getcwd()}/graphics/buttons/exit_button.png",
...
class LevelGenerator(tk.Canvas):
    ...
    def __init__(self, parent, controller):
        ...
        generate_lvl_button = CustomButton(master=self,
                                           image_path=f"{os.getcwd()}/graphics/buttons/generate_button.png",
        ...
        save_button = CustomButton(master=self,
                                   image_path=f"{os.getcwd()}/graphics/buttons/save_button.png",
    ...
    def save():
        ...
        src = str(os.getcwd()) + r"\levels\tmp.txt"
        dst = str(os.getcwd()) + fr"\levels\{level_name}"
    ...
    def add_option(self,
        ...
        image = tk.PhotoImage(file=f"{os.getcwd()}/graphics/texts/{text_name}.png")
        # to prevent the image from being deleted by garbage collector we save it in dict.
        ...
        increase_button = CustomButton(master=self,
                                       image_path=f"{os.getcwd()}/graphics/buttons/increase_button.png",
        ...
        decrease_button = CustomButton(master=self,
                                       image_path=f"{os.getcwd()}/graphics/buttons/decrease_button.png",
                                       command=lambda: [
    ...
    def update_numbers(self,
        ...
        dec = number_str[0]
        unity = number_str[1]
        n1 = tk.PhotoImage(file=f"{os.getcwd()}/graphics/numbers/{dec}.png")
        n2 = tk.PhotoImage(file=f"{os.getcwd()}/graphics/numbers/{unity}.png")
        # to prevent the image from being deleted by garbage collector we save it in dict..
...
class Leaderboard(tk.Canvas):
    ...
    def __init__(self, parent, controller):
        ...
        bg = ImageTk.PhotoImage(
            Image.open(f"{os.getcwd()}/graphics/leaderboard_tab.png").resize((controller.width, controller.height),
                                                                             Image.ANTIALIAS))
        self.create_image(0, 0, anchor="nw", image=bg)
        self.images = {"bg": bg}
        self.controller = controller
    ...
    def draw_position(self,
        ...
        """
        image = tk.PhotoImage(file=f"{os.getcwd()}/graphics/numbers/{str(position)}.png")
        # to prevent the image from being deleted by garbage collector we save it in dict.
    ...
    def draw_name(self,
        ...
        for i, char in enumerate(name):
            image = ImageTk.PhotoImage(
                Image.open(f"{os.getcwd()}/graphics/characters/{char}.png").resize((51, 51), Image.ANTIALIAS))
            # to prevent the image from being deleted by garbage collector we save it in dict.
    ...
    def draw_score(self,
        ...
        for i, num in enumerate(score):
            image = ImageTk.PhotoImage(Image.open(f"{os.getcwd()}/graphics/numbers/{num}.png"))
            # to prevent the image from being deleted by garbage collector we save it in dict..
...
class Instruction(tk.Canvas):
    ...
    def __init__(self, parent, controller):
        ...
        tk.Canvas.__init__(self, parent, width=controller.width, height=controller.height)
        bg = ImageTk.PhotoImage(
            Image.open(f"{os.getcwd()}/graphics/instruction_tab.png").resize((controller.width, controller.height),
                                                                             Image.ANTIALIAS))
        self.create_image(0, 0, anchor="nw", image=bg)
        self.controller = controller
        self.image = bg
