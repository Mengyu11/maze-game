...
class BuildingBlock:
    ...
    def draw(self,
        ...
        image = ImageTk.PhotoImage(Image.open(f"{os.getcwd()}/graphics/building_block/{block_type}.png").\
                                   resize((int(size),
                                           int(size)),
                                   Image.ANTIALIAS))
...
class Player:
    ...
    def move(self,
        ...
        if target_block.block_type == "C":
            pygame.mixer.Channel(1).play(pygame.mixer.Sound(f"{os.getcwd()}/sounds/coin_pick.wav"))
    ...
    def destroy_block(self):
        ...
        pygame.mixer.Channel(0).play(pygame.mixer.Sound(f"{os.getcwd()}/sounds/digging.wav"))
    ...
    def draw(self,
        ...
        image = ImageTk.PhotoImage(Image.open(f"{os.getcwd()}/graphics/gnome/{gnome_image[str(self.direction)]}.png").
